...
prof_0_5 <- lapply(X = list.files("/dados/projetos_andamento/TRADEhub/Linha_2/soil_data/phh2o",pattern = profundidades[1],full.names = T),raster)

prof_5_15 <- lapply(X = list.files("/dados/projetos_andamento/TRADEhub/Linha_2/soil_data/phh2o",pattern = profundidades[2],full.names = T),raster)

prof_15_30 <- lapply(X = list.files("/dados/projetos_andamento/TRADEhub/Linha_2/soil_data/phh2o",pattern = profundidades[3],full.names = T),raster)
...
writeRaster(combined_0_5m, filename ="/dados/projetos_andamento/TRADEhub/Linha_2/soil_data/phh2o/mosaico/phh2o_0_5cm_BR.tif" , format = "GTiff", options = "COMPRESS=DEFLATE")

writeRaster(combined_5_15m, filename ="/dados/projetos_andamento/TRADEhub/Linha_2/soil_data/phh2o/mosaico/phh2o_5_15cm_BR.tif" , format = "GTiff", options = "COMPRESS=DEFLATE")

writeRaster(combined_15_30m, filename ="/dados/projetos_andamento/TRADEhub/Linha_2/soil_data/phh2o/mosaico/phh2o_15_30cm_BR.tif" , format = "GTiff", options = "COMPRESS=DEFLATE")
